...
I've made some videos on manipulating and animating paths which might be a good place to start if you'd prefer - playlist for [PureSwiftUIDesign][pure-swift-ui-design] can be found [here][layout-guides-playlist]: 
...
<a href="https://youtu.be/KZtCMg7q2m8" target="_blank"><img src="../../../Assets/Images/LayoutGuides/layout-guides_part-03_thumbnail.png" 
alt="Bezier Curves Layout Guides" class="thumbnail"/></a>
<a href="https://youtu.be/kNa1uuE7Thk" target="_blank"><img src="../../../Assets/Images/LayoutGuides/layout-guides_part-04_thumbnail.png" 
...
let angleTop: Angle = .bottomLeading // 90 degrees
let angleCustom: Angle = .cycle(0.75) // 180 degrees
let angleBottomRight = 45.degrees
```
